...
$update_mtypesalary = "";
$delete_mtypesalary = "";
$query              = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '24' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mtypesalary = $roww["xcreate"];
        $read_mtypesalary   = $roww["xread"];
        $update_mtypesalary = $roww["xupdate"];
        $delete_mtypesalary = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/typesalary/v_typesalary.php"; ?>
            </div>
