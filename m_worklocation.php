...
$create_mworklocation = "";
$read_mworklocation   = "";
$update_mworklocation = "";
$delete_mworklocation = "";
$query                = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '20' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mworklocation = $roww["xcreate"];
        $read_mworklocation   = $roww["xread"];
        $update_mworklocation = $roww["xupdate"];
        $delete_mworklocation = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/worklocation/v_worklocation.php"; ?>
            </div>
