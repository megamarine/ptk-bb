...
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '7' and xdelete = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
if(isset($_GET["KODE"]))
    {
        ...
        "'', 'Hapus Master Section - $KODE', '$IP_ADDRESS','$ID_USER1','$DINO','$ID_USER1','Master','Hapus'");
