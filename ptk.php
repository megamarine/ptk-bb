...
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '13' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_ptk = $roww["xcreate"];
        $read_ptk   = $roww["xread"];
        $update_ptk = $roww["xupdate"];
        $delete_ptk = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
?>
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/ptk/v_ptk.php"; ?>
            </div>
