...
$update_mdiv = "";
$delete_mdiv = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '5' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mdiv = $roww["xcreate"];
        $read_mdiv   = $roww["xread"];
        $update_mdiv = $roww["xupdate"];
        $delete_mdiv = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/divisi/v_divisi.php"; ?>
            </div>
