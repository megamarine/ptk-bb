...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-external-link-alt"></i> Edit Grade</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                <li><a href="menuutama"><i class="ico-home2"></i> Dashboard</a></li>
                <li><a href="m_level"><i class="fas fa-external-link-alt"></i> Grade</a></li>
                <li class="active"><i class="ico-pencil"></i> Edit Grade</li>
            </ol>
        </div>
    </div>
</div>
