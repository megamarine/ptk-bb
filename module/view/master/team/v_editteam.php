<?php
include "module/controller/master/team/t_team.php";
?>
...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-users"></i></i> Edit Team</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                <li><a href="menuutama"><i class="ico-home2"></i> Dashboard</a></li>
                <li><a href="m_team"><i class="fas fa-users"></i></i> Team</a></li>
                <li class="active"><i class="ico-pencil"></i> Edit Team</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <form role="form" action="" method="post" data-parsley-validate>             
            ...
            <div class="row">                
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="SUBSECTION" id="SUBSECTION" required="" class="form-control" data-parsley-required>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="TEAM">Team Code <span class="text-danger">*</span></label>
                        <input type="text" autocomplete="off" required="" oninput="getMASTER_TEAM(this.value);" onkeypress="return event.keyCode!=13" class="form-control" id="TEAM" name="TEAM" value="<?php echo $TEAM; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="NAMATEAM">Team Name <span class="text-danger">*</span></label>
                        <input type="text" autocomplete="off" required="" class="form-control" id="NAMATEAM" name="NAMATEAM" value="<?php echo $NAMATEAM; ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12" align="center">
                    ...
                    <a href="m_team" type="button" class="btn btn-danger"><i class="fa fa-times fa-lg"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
