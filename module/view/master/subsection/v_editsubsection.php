<?php
include "module/controller/master/subsection/t_subsection.php";
?>
...
function getMASTER_SUBSECTION(val) {
  $.ajax({
  type: "POST",
  url: "cek_m_subsection.php",
  data:'SUBSECTION='+val,
  success: function(data){
    $("#DATA_INFO").html(data);
  }
...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-pizza-slice"></i> Edit Sub Section</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                <li><a href="menuutama"><i class="ico-home2"></i> Dashboard</a></li>
                <li><a href="m_subsection"><i class="fas fa-pizza-slice"></i> Sub Section</a></li>
                <li class="active"><i class="ico-pencil"></i> Edit Sub Section</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <form role="form" action="" method="post" data-parsley-validate>             
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="DIVISI" id="DIVISI" required="" class="form-control" onchange="getKODE_SECTION(this.value);"  data-parsley-required>
                            ...
                            <?php
                            $stmj = GetQuery("select * from m_divisi where kode_departement = '$DEPARTEMENT'");
                            while ($rowz = $stmj->fetch(PDO::FETCH_ASSOC)) 
                            {
                                ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="SECTION" id="SECTION" required="" class="form-control" data-parsley-required>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="SUBSECTION">Sub Section Code <span class="text-danger">*</span></label>
                        <input type="text" autocomplete="off" required="" oninput="getMASTER_SUBSECTION(this.value);" onkeypress="return event.keyCode!=13" class="form-control" id="SUBSECTION" name="SUBSECTION" value="<?php echo $SUBSECTION; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="NAMASUBSECTION">Sub Section Name <span class="text-danger">*</span></label>
                        <input type="text" autocomplete="off" required="" class="form-control" id="NAMASUBSECTION" name="NAMASUBSECTION" value="<?php echo $NAMASUBSECTION; ?>">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12" align="center">
                    ...
                    <a href="m_subsection" type="button" class="btn btn-danger"><i class="fa fa-times fa-lg"></i> Cancel</a>
                </div>
            </div>
        </form>
    </div>
