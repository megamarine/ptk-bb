...
function CekJumlah(GRADE)
{
    switch(GRADE)
    {
        ...
        break;
        default : document.getElementById('QTY_SUBMITION').readOnly = true;
                  document.getElementById('QTY_SUBMITION').value = 1;
    }
...
<div class="page-header page-header-block">
    <div class="page-header-section">
        <h4 class="title semibold"><i class="fas fa-hand-holding-medical fa-lg"></i> Edit PTK</h4>
    </div>
    <div class="page-header-section">
        <div class="toolbar">
            <ol class="breadcrumb breadcrumb-transparent nm">
                ...
                <li class="active"><i class="fas fa-pencil-alt"></i> Edit PTK</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div id="noso">
                     <?php
                        ...
                        { ?>
                           <div class= "col-md-4"> 
                             <div class="form-group">
                               <label for="SO_NUMBER">Nomer Usulan SO <span class="text-danger">*</span></label><input  type="text" class="form-control" autocomplete="off" required="" id="SO_NUMBER" name="SO_NUMBER" value="<?php echo $SO_NUMBER; ?>"  data-parsley-required> 
                            </div> 
                          </div>
                          <div class="col-md-4">
                            <div class="form-group">
                               <label for="FILE">Upload Scan Form Usulan SO </label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" autocomplete="off" required="" readonly oninput="hitungJumlah(this.value)" class="form-control" id="QTY_SUBMITION" name="QTY_SUBMITION" value="<?php echo $QTY_SUBMITION; ?>" title="Hanya Level Operator Grade 8B2 yang bisa mengajukan lebih dari 1 orang">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="TYPE_APD" id="TYPE_APD" required="" readonly="" class="form-control" data-parsley-required title="Bergantung pada Type Pekerja yang dipilih">
                            <?php
                                $results = getQuery("select * from m_typeworker where worktype_code = '$TYPE_APD' order by worktype_code asc");
                                while ($rowz = $results->fetch(PDO::FETCH_ASSOC)) 
                                {
                                    ?>
                                        <option value="<?php echo $rowz["worktype_code"]; ?>"
                                            <?php 
                                                if($TYPE_APD == $rowz["worktype_code"]) 
                                                { 
                                                    echo "selected"; 
                                                } 
                                            ?>>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="TYPE_MCU" id="TYPE_MCU" required="" class="form-control" data-parsley-required>
                            <option value="">Choose Type MCU</option>
                            <?php
                                $results = getQuery("select * from m_typemcu where basedsalary_code = '$BASED_SALARY' order by mcu_code asc");
                                while ($rowz = $results->fetch(PDO::FETCH_ASSOC)) 
                                {
                                    ?>
                                        <option value="<?php echo $rowz["mcu_code"]; ?>"
                                            <?php 
                                                if($TYPE_MCU == $rowz["mcu_code"]) 
                                                { 
                                                    echo "selected"; 
                                                } 
                                            ?>>
                                            <?php echo $rowz["mcu_name"]; ?>
                                        </option>
                                    <?php
                                }
                            ?>    
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" multiple="multiple" id="JAM_KERJA" name="JAM_KERJA[]">
                        <?php 
                        $results = getQuery("select * from m_jamkerja where work_location = '$WORK_LOCATION'");
                        while($rowz = $results->fetch(PDO::FETCH_ASSOC))
                        {
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="SHIFT" id="SHIFT" required="" class="form-control" data-parsley-required>
                        ...
                        <div class="container" style="border:1px solid #ced6d4;border-radius: 5px; width:100%; height: 15em; overflow-y: auto;">
                            <table class="d">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_PC" name="inpITFAC_PC" class="tesinput" value="<?=$inpITFAC_PC;?>" autocomplete="off" placeholder="Keterangan Fasilitas Komputer" style="width:100%;height: 50%;display: none;">
                                    </td>
                                <tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_LAPTOP" name="inpITFAC_LAPTOP" class="tesinput" value="<?=$inpITFAC_LAPTOP;?>" autocomplete="off" placeholder="Keterangan Fasilitas Laptop" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_EXTDISK" name="inpITFAC_EXTDISK" class="tesinput" value="<?=$inpITFAC_EXTDISK;?>" autocomplete="off" placeholder="Keterangan Fasilitas External Disk" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_MOBILEPHONE" name="inpITFAC_MOBILEPHONE" class="tesinput" value="<?=$inpITFAC_MOBILEPHONE;?>" autocomplete="off" placeholder="Keterangan Fasilitas Mobile Phone" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <hr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_EMAIL" name="inpITFAC_EMAIL" class="tesinput" value="<?=$inpITFAC_EMAIL;?>" autocomplete="off" placeholder="Keterangan Fasilitas Email" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_FINGER_ACCESS" name="inpITFAC_FINGER_ACCESS" class="tesinput" value="<?=$inpITFAC_FINGER_ACCESS;?>" autocomplete="off" placeholder="Keterangan Fasilitas Finger Access" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_FACEREC_ACCESS" name="inpITFAC_FACEREC_ACCESS" class="tesinput" value="<?=$inpITFAC_FACEREC_ACCESS;?>" autocomplete="off" placeholder="Keterangan Fasilitas Face Recognition Access" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_CCTV_ACCESS" name="inpITFAC_CCTV_ACCESS" class="tesinput" value="<?=$inpITFAC_CCTV_ACCESS;?>" autocomplete="off" placeholder="Keterangan Fasilitas CCTV Access" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_GPS_ACCESS" name="inpITFAC_GPS_ACCESS" class="tesinput" value="<?=$inpITFAC_GPS_ACCESS;?>" autocomplete="off" placeholder="Keterangan Fasilitas GPS Access" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_VPN" name="inpITFAC_VPN" class="tesinput" value="<?=$inpITFAC_VPN;?>" autocomplete="off" placeholder="Keterangan Fasilitas VPN" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_WIFI" name="inpITFAC_WIFI" class="tesinput" value="<?=$inpITFAC_WIFI;?>" autocomplete="off" placeholder="Keterangan Fasilitas Wifi" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_FILESERV" name="inpITFAC_FILESERV" class="tesinput" value="<?=$inpITFAC_FILESERV;?>" autocomplete="off" placeholder="Keterangan Fasilitas File Server" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_ACTS" name="inpITFAC_ACTS" class="tesinput" value="<?=$inpITFAC_ACTS;?>" autocomplete="off" placeholder="Keterangan Fasilitas ACTS" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_HRMS" name="inpITFAC_HRMS" class="tesinput" value="<?=$inpITFAC_HRMS;?>" autocomplete="off" placeholder="Keterangan Fasilitas HRMS" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_CAS" name="inpITFAC_CAS" class="tesinput" value="<?=$inpITFAC_CAS;?>" autocomplete="off" placeholder="Keterangan Fasilitas CAS" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_WEBBC" name="inpITFAC_WEBBC" class="tesinput" value="<?=$inpITFAC_WEBBC;?>" autocomplete="off" placeholder="Keterangan Fasilitas Web BC" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_TPB" name="inpITFAC_TPB" class="tesinput" value="<?=$inpITFAC_TPB;?>" autocomplete="off" placeholder="Keterangan Fasilitas TPB" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_TICKETING" name="inpITFAC_TICKETING" class="tesinput" value="<?=$inpITFAC_TICKETING;?>" autocomplete="off" placeholder="Keterangan Fasilitas Ticketing System / Maintenance Online" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_PTK" name="inpITFAC_PTK" class="tesinput" value="<?=$inpITFAC_PTK;?>" autocomplete="off" placeholder="Keterangan Fasilitas PTK Online" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_SHIPMENT" name="inpITFAC_SHIPMENT" class="tesinput" value="<?=$inpITFAC_SHIPMENT;?>" autocomplete="off" placeholder="Keterangan Fasilitas Shipment Online" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_SPEC" name="inpITFAC_SPEC" class="tesinput" value="<?=$inpITFAC_SPEC;?>" autocomplete="off" placeholder="Keterangan Fasilitas Spec Online" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_RECRUITMENT" name="inpITFAC_RECRUITMENT" class="tesinput" value="<?=$inpITFAC_RECRUITMENT;?>" autocomplete="off" placeholder="Keterangan Fasilitas Recruitment Online" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" id="inpITFAC_VMS" name="inpITFAC_VMS" class="tesinput" value="<?=$inpITFAC_VMS;?>" autocomplete="off" placeholder="Keterangan Fasilitas Visitor Management System" style="width:100%;height: 50%;display: none;">
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="KRITERIA" name="KRITERIA" placeholder="Kriteria Yang Dibutuhkan" style="width:100%; height: 12em;"><?=$KRITERIA;?></textarea>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="JOBDESC">Jobdesc <span class="text-danger">*</span></label><br>
                        <textarea class="form-control" id="JOBDESC" name="JOBDESC" placeholder="Tugas Pokok" style="width:100%; height: 12em;"><?=$JOBDESC;?></textarea>
                    </div>
                </div>
            </div>
            <br><br>                   
