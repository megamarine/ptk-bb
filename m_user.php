...
$update_muser = "";
$delete_muser = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '1' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_muser = $roww["xcreate"];
        $read_muser   = $roww["xread"];
        $update_muser = $roww["xupdate"];
        $delete_muser = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
