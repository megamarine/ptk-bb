...
$update_mshift = "";
$delete_mshift = "";
$query            = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '25' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mshift = $roww["xcreate"];
        $read_mshift   = $roww["xread"];
        $update_mshift = $roww["xupdate"];
        $delete_mshift = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/shift/v_shift.php"; ?>
            </div>
