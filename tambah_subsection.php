...
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '8' and xcreate = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/subsection/v_tambahsubsection.php"; ?>
            </div>
