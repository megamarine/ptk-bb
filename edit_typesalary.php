...
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '24' and xupdate = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/typesalary/v_edittypesalary.php"; ?>
            </div>
