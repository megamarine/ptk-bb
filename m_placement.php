...
$update_mplacement = "";
$delete_mplacement = "";
$query             = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '23' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mplacement = $roww["xcreate"];
        $read_mplacement   = $roww["xread"];
        $update_mplacement = $roww["xupdate"];
        $delete_mplacement = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/placement/v_placement.php"; ?>
            </div>
