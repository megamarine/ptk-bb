...
$update_mjenkar = "";
$delete_mjenkar = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '2' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mjenkar = $roww["xcreate"];
        $read_mjenkar   = $roww["xread"];
        $update_mjenkar = $roww["xupdate"];
        $delete_mjenkar = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/jenis_karyawan/v_jeniskaryawan.php"; ?>
            </div>
