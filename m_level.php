...
$update_mlevel = "";
$delete_mlevel = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '12' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mlevel = $roww["xcreate"];
        $read_mlevel   = $roww["xread"];
        $update_mlevel = $roww["xupdate"];
        $delete_mlevel = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/level/v_level.php"; ?>
            </div>
