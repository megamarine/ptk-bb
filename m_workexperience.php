...
$query                = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '21' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mworkexp = $roww["xcreate"];
        $read_mworkexp   = $roww["xread"];
        $update_mworkexp = $roww["xupdate"];
        $delete_mworkexp = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/workexperience/v_workexperience.php"; ?>
            </div>
