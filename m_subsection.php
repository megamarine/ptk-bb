...
$update_msubsec = "";
$delete_msubsec = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '8' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_msubsec = $roww["xcreate"];
        $read_msubsec   = $roww["xread"];
        $update_msubsec = $roww["xupdate"];
        $delete_msubsec = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/subsection/v_subsection.php"; ?>
            </div>
