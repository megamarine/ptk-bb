...
$update_mdept = "";
$delete_mdept = "";
$query      = getQuery("select * from m_usermodule where kode_user = '$KODE_USER' and id_module = '4' and xread = '1'");
$cek = $query->rowCount();
if($cek == 0)
{
    ?> 
...
else
{
    ...
    {
        $create_mdept = $roww["xcreate"];
        $read_mdept   = $roww["xread"];
        $update_mdept = $roww["xupdate"];
        $delete_mdept = $roww["xdelete"];
    }
}
// ---------------------------------------------------------------------------------------------------------------------------------
    ...
    <body>
        ...
        <section id="main" role="main">
            <div class="container-fluid">
                <?php include "module/view/master/departement/v_departement.php"; ?>
            </div>
