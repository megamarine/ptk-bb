...
<html class="backend">
    ...
    <body style="background-color:#dba530">
    <script type="text/javascript">
      ...
      <!-- PENGUMUMAN -->
        ...
        <div class="wrapper fadeInDown">
            <a class="btn btn-primary" href="manual book/WHAT-NEWS.pdf" target="_blank"><span class="icon"><i class="ico-info"></i></span> Klik disini untuk melihat apa yang baru pada PTK Online</a><br>
            <div id="formContent"><br>
                <h1 class="active"> <strong>PTK Online</strong> </h1>
                <div class="fadeIn first">
                  <img src="assets/image/images/bb.png" width="40%">
                </div><br>
                <form method="post">
                    ...
                    <div class="col-lg-4 col-lg-offset-4">
                        <form class="panel" method="post" action="">
                            <div class="panel-body">
                                <h1 align="center" style="font-weight: bold;">PTK Online</h1>
                                <div align="center">
